import { MessageCircle, MapPin, Mail, Send, Clock, Instagram } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-[var(--color-earth-dark)]">Mon-Sun: 6:00 AM - 9:00 PM</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
              <div className="bg-[var(--color-sand)] h-80 flex items-center justify-center relative">
                {/* You can replace this with an actual Google Maps embed like: */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--color-stone)] leading-relaxed">
                    Room906 PT Residece Bldg. <br />
                    Suthep, Muang-chiangmai<br />
                    CHIANGMAI<br />
                    50200
                    <br />
                  </p>
